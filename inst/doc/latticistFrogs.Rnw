...
\SweaveOpts{engine=R,eps=FALSE,echo=FALSE,prefix.string=figs/frogs,width=5,height=3.8}
...
\begin{frame}[fragile]
  ...
  The dataset here is \code{frogs}, available in the \pkg{DAAG} package.
